...
export default function CandidateSearchHelp() {
  const candidateData = {
  ...
  return (
    <div className="profilehelp-page">
      ...
      <div className="profilehelp-container">
        <h1 className="profilehelp-title">{candidateData.title}</h1>
        <p className="profilehelp-updated">{candidateData.updatedDate}</p>
        <p className="profilehelp-intro">{candidateData.intro}</p>
